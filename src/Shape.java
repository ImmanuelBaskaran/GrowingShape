...
//            myPoint.setLocation(myPoint.getX() +delta.getX(),myPoint.getY()+delta.getY());
//        }
//        x+=delta.getX();
//        y+=delta.getY();
//        recalculatePolygon();
...
//        recalculatePolygon();
//    }
//    public void rotateAround(double angle, Point2D myPoint) {
//        Point2D[] pt = new Point2D[points.size()];
//        points.toArray(pt);
//        Point2D center = calculateCentroid();
//        AffineTransform.getRotateInstance(Math.toRadians(angle), myPoint.getX(), myPoint.getY())
//                .transform(pt, 0, pt, 0, points.size()); // specifying to use this double[] to hold coords
//        recalculatePolygon();
//    }
//
